    ...
    <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 20 }}>
      <ResponsiveContainer width="100%" height={280}>
        <BarChart data={RAW.nsr_monthly}>
          ...
          <Bar dataKey="positive" name="Tích cực" stackId="a" fill={T.positive} />
          <Bar dataKey="neutral" name="Trung lập" stackId="a" fill={T.neutral} />
          <Bar dataKey="negative" name="Tiêu cực" stackId="a" fill={T.negative} />
        </BarChart>
      </ResponsiveContainer>
