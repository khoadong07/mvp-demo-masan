    ...
    <div style={{ height: "100vh", background: "linear-gradient(135deg,#0D2444 0%,#143F72 60%,#1A5FA8 100%)", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ background: T.white, borderRadius: 20, padding: "44px 40px", width: 420, boxShadow: "0 24px 60px rgba(0,0,0,.25)" }}>
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          <div style={{ width: 60, height: 60, borderRadius: 14, background: "linear-gradient(135deg,#1877C8,#143F72)", color: "#fff", fontSize: 20, fontWeight: 900, display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 14px" }}>M</div>
          <div style={{ fontSize: 10, fontWeight: 900, color: T.navyDark, letterSpacing: 2, marginBottom: 4 }}>MASAN GROUP</div>
